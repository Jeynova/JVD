...
class __TwigTemplate_9d56f14687a390a155e7a5901db28dac7760aa65da3f4ce04f8560a291435741 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        echo "\" class=\"teal-text\" style=\"display: block; margin: 1% 0\">Didn't have some account ? Sign in</a>
...
<form method=\"post\">
    ...
    #}
    <a href=\"{{ path(\"app_register\") }}\" class=\"teal-text\" style=\"display: block; margin: 1% 0\">Didn't have some account ? Sign in</a>
    <button class=\"btn btn-lg btn-primary\" type=\"submit\">
        Log in
    </button>
</form>
{% endblock %}
", "security/login.html.twig", "/Applications/MAMP_2019-08-23_09-35-41/htdocs/JVD/JVD/templates/security/login.html.twig");
    }
}

...
class __TwigTemplate_9a10bd2720cfb85dc31885e7e7d672d3a9bdef05ac60ed2f1fd9a53b2ceac27c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 8
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formPicture"]) || array_key_exists("formPicture", $context) ? $context["formPicture"] : (function () { throw new RuntimeError('Variable "formPicture" does not exist.', 8, $this->source); })()), 'form');
        echo "
";
    ...
    {
        return array (  93 => 8,  90 => 7,  80 => 6,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{{ form(formPicture) }}
{% endblock %}", "picture/addPicture.html.twig", "/Applications/MAMP_2019-08-23_09-35-41/htdocs/JVD/JVD/templates/picture/addPicture.html.twig");
    }
}

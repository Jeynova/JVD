...
class __TwigTemplate_bc5ae59e403c2d455063a99b3eca3412835fb3cdcd62eae6a024b2e03240e05a extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["picture"]) {
            ...
            echo "</td>
                <td>";
            // line 25
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["picture"], "user", [], "any", false, false, false, 25), "username", [], "any", false, false, false, 25), "html", null, true);
            echo "</td>
                <td>";
            // line 26
            ...
            echo "</td>
                <td>";
            // line 28
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["picture"], "date", [], "any", false, false, false, 28), "d-m-Y"), "html", null, true);
            echo "</td>
                <td>";
            // line 29
            ...
            echo "</td>
                <td><img src=\"";
            // line 30
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/images/" . twig_get_attribute($this->env, $this->source, $context["picture"], "image", [], "any", false, false, false, 30))), "html", null, true);
            echo "\" alt=\"";
            ...
            echo "\"></td>
                <td>
                    <a href=\"";
            // line 32
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("picture_show", ["id" => twig_get_attribute($this->env, $this->source, $context["picture"], "id", [], "any", false, false, false, 32)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 33
...
";
    ...
    {
        return array (  162 => 39,  158 => 37,  148 => 33,  144 => 32,  137 => 30,  133 => 29,  129 => 28,  125 => 27,  121 => 26,  117 => 25,  113 => 24,  110 => 23,  106 => 22,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <table>
        ...
        {% for picture in pictures %}
            <tr>
                <td>{{ picture.id }}</td>
                <td>{{ picture.user.username }}</td>
                <td>{{ picture.name }}</td>
                <td>{{ picture.title }}</td>
                <td>{{ picture.date | date('d-m-Y') }}</td>
                <td>{{ picture.description }}</td>
                <td><img src=\"{{ asset('uploads/images/'~ picture.image) }}\" alt=\"{{ picture.title }}\"></td>
                <td>

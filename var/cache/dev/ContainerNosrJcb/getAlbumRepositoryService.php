...
// Returns the private 'App\Repository\AlbumRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AlbumRepository.php';

return $this->privates['App\\Repository\\AlbumRepository'] = new \App\Repository\AlbumRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

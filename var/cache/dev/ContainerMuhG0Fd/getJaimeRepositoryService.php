...
// Returns the private 'App\Repository\JaimeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/JaimeRepository.php';

return $this->privates['App\\Repository\\JaimeRepository'] = new \App\Repository\JaimeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

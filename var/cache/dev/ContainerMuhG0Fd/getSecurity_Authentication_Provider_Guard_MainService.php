...
}, 1), ($this->privates['security.user.provider.concrete.user'] ?? $this->load('getSecurity_User_Provider_Concrete_UserService.php')), 'main', new \Symfony\Component\Security\Core\User\UserChecker());

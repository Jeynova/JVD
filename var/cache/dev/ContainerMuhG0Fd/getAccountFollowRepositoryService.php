...
// Returns the private 'App\Repository\AccountFollowRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AccountFollowRepository.php';

return $this->privates['App\\Repository\\AccountFollowRepository'] = new \App\Repository\AccountFollowRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
